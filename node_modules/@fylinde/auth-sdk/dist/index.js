...
__export(src_exports, {
  ...
  FylindeAuthClient: () => FylindeAuthClient,
  FylindeExternalAuth: () => FylindeExternalAuth,
  GraphQLError: () => GraphQLError,
  createFylindeAuthClient: () => createFylindeAuthClient
});
module.exports = __toCommonJS(src_exports);

// src/FylindeRefreshTokenStorageHandler.ts
var getStorageAuthEventKey = (prefix) => [prefix, "fylinde_storage_auth_change"].filter(Boolean).join("+");
var getStorageAuthStateKey = (prefix) => [prefix, "fylinde_auth_module_auth_state"].filter(Boolean).join("+");
var getRefreshTokenKey = (prefix) => [prefix, "fylinde_auth_module_refresh_token"].filter(Boolean).join("+");
var FylindeRefreshTokenStorageHandler = class {
...
// src/FylindeAccessTokenStorageHandler.ts
var getAccessTokenKey = (prefix) => [prefix, "fylinde_auth_access_token"].filter(Boolean).join("+");
var FylindeAccessTokenStorageHandler = class {
  constructor(storage, prefix) {
    this.storage = storage;
    this.prefix = prefix;
  }
...
var ExternalProvider = /* @__PURE__ */ ((ExternalProvider2) => {
  ...
  ExternalProvider2["FylindeCloud"] = "cloud_auth.CloudAuthorizationPlugin";
  return ExternalProvider2;
})(ExternalProvider || {});

// src/FylindeExternalAuth.ts
...
var FylindeExternalAuth = class {
  constructor(fylindeURL, provider) {
    this.fylindeURL = fylindeURL;
