...
type FylindeAuthEvent = CustomEvent<{
    authState: AuthState;
}>;
declare class FylindeRefreshTokenStorageHandler {
    private storage;
    private prefix?;
...
export { type AuthState, type FylindeAuthEvent, FylindeRefreshTokenStorageHandler, getRefreshTokenKey, getStorageAuthEventKey, getStorageAuthStateKey };
