...
import { type FormDataBase } from "../../hooks/useForm";
import {
	type CommonVars,
	type MutationBaseFn,
	type MutationData,
	...
	type ParserFunction,
	type SimpleSubmitFn,
} from "../../hooks/useSubmit/types";
import { type ApiErrors } from "../../hooks/useGetParsedErrors/types";
import { extractMutationData, extractMutationErrors } from "../../hooks/useSubmit/utils";
...
>({
	...
	const { setCheckoutUpdateState } = scope
		? useCheckoutUpdateStateChange(scope)
		: { setCheckoutUpdateState: () => { } }; // Provide a fallback function
