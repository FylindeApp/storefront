...
import { createAdyenCheckoutConfig } from "../../../../../components/checkout/sections/PaymentSection/AdyenDropIn/utils";
import {
	type AdyenDropinProps,
	useAdyenDropin,
} from "../../../../../components/checkout/sections/PaymentSection/AdyenDropIn/useAdyenDropin";
import "@adyen/adyen-web/dist/adyen.css";
import { type AdyenGatewayInitializePayload } from "../../../../../components/checkout/sections/PaymentSection/AdyenDropIn/types";
...
export const AdyenDropIn: FC<AdyenDropinProps> = ({ config }) => {
	...
	const createAdyenCheckoutInstance = useCallback(
		...
		[onAdditionalDetails, onSubmit] // ✅ Correct dependencies
	);
	...
	}, [dropinContainerElRef, config.data, createAdyenCheckoutInstance]); // ✅ Correct dependency array
